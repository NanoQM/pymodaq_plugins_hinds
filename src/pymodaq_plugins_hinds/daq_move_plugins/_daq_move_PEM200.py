...
class DAQ_Move_PEM200(DAQ_Move_base):
    ...
    params = [
                 # {'title': 'Resource Name:', 'name': 'resource_name', 'type': 'str',
                 #  'value': "VISA-RESOURCE-PLACEHOLDER"},
                 # {'title': 'wavelength used:', 'name': 'wavelength', 'type': 'float', 'value': 632.8},
                 # {'title': 'retardation:', 'name': 'retardation', 'type': 'float', 'value': 0.5},
                 # # {'title': 'frequency:', 'name': 'frequency', 'type': 'float', 'readonly': True},  # DK - add a parameter here for the frequency
                 # {'title': 'State:', 'name': 'state', 'type': 'int', 'value': 0, 'limits': [0, 1]}
